...
use DataStructure\Ordinations\QuickSort;
...
class QuickSortTest extends TestCase
{
     ...
     */
    public static function testOrdinationQuickSort_withDisorderedArrays_shouldOrderTheArrays(
        array $disorderedArray,
        array $orderedArray
    ): void
    {
        $orderedArrayByBubbleSort = QuickSort::exec($disorderedArray);
