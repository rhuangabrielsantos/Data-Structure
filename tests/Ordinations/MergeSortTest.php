...
use DataStructure\Ordinations\MergeSort;
...
class MergeSortTest extends TestCase
{
     ...
     */
    public static function testOrdinationMergeSort_withDisorderedArrays_shouldOrderTheArrays(
        array $disorderedArray,
        array $orderedArray
    ): void
    {
        $orderedArrayByBubbleSort = (new MergeSort())->mergeSort($disorderedArray);
