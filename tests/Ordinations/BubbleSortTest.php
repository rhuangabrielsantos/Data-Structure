...
use DataStructure\Ordinations\BubbleSort;
...
class BubbleSortTest extends TestCase
{
     ...
     */
    public static function testOrdinationBubbleSort_withDisorderedArrays_shouldOrderTheArrays(
        array $disorderedArray,
        array $orderedArray
    ): void
    {
        $orderedArrayByBubbleSort = BubbleSort::exec($disorderedArray);
