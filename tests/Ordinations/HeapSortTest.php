...
use DataStructure\Ordinations\HeapSort;
...
class HeapSortTest extends TestCase
{
     ...
     */
    public static function testOrdinationHeapSort_withDisorderedArrays_shouldOrderTheArrays(
        array $disorderedArray,
        array $orderedArray
    ): void
    {
        $orderedArrayByBubbleSort = (new HeapSort())->exec($disorderedArray, count($disorderedArray));
